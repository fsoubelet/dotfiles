...
<head>
	...
	<link href="https://framework.web.cern.ch/framework/2.0/cern_toolbar/css/screen.css" rel="stylesheet" type="text/css"> 
	<link href="https://framework.web.cern.ch/framework/2.0/cern_toolbar/css/toolbar.css" rel="stylesheet" type="text/css"> 

<body class="lang-en fluid notoppadding" >
	...
	<div id="cern-toolbar" class="user-not-authenticated"> 
		<h1 class="h1tb" style="display:inline;">
			<a href="http://cern.ch">CERN <span>Accelerating science</span></a>
		</h1> 
		<ul class="noarrow"> 
		<!--li id="a-signin" class="noarrow"><a  class="noarrow" href="" title="Sign in" >Sign in</a></li>-->
		<li id="a-directory"><a class="noarrow" href="http://cern.ch/directory" title="CERN Directory">Directory</a></li>
		</ul> 
	</div>
